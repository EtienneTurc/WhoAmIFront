								...
								<swiper-slide>
									...
									<v-tooltip bottom>
										<template v-slot:activator="{ on }">
											<span v-on="on">
												<v-checkbox v-model="loginWithFacebook" :label="`Facebook`" color="primary"></v-checkbox>
											</span>
										</template>
									...
									<div class="text-center">
										<v-btn text large @click="swiper.slideTo(0, 1000, false)" class="white--text mr-9">
											<v-icon color="primary">mdi-arrow-left</v-icon>
										</v-btn>
										<v-btn large @click="startLogin" color="attention" class="white--text ml-9">Se connecter</v-btn>
									</div>
								</swiper-slide>
							</swiper>
						</div>
